...
function Terrestres (){
  ...
  const [Deportes,setDeporte] = useState(['futbol']);
...
return(
  ...
  <Header/>
    ...
    <div id="titulo" className={`${stylesTerrestres.titulo}`}>
    ...
    <div id="cuerpo" className={`${stylesTerrestres.cuerpo}`}>
      ...
      <div id="fila" className={`${stylesTerrestres.fila}`}>
