...
function CrearNoticia(){
    ...
    <div className={`${stylesCrearNoticia.tabla}`}>
        ...
        <div className={`${stylesCrearNoticia.atributos}`}>
          <div className={`${stylesCrearNoticia.atributo} ${stylesCrearNoticia.fecha}`}> <h2 className={`${stylesCrearNoticia.h2}`}>FECHA</h2></div>
          <div className={`${stylesCrearNoticia.atributo} ${stylesCrearNoticia.nombre}`}> <h2 className={`${stylesCrearNoticia.h2}`}>NOMBRE</h2></div>
          <div className={`${stylesCrearNoticia.atributo} ${stylesCrearNoticia.docente}`}> <h2 className={`${stylesCrearNoticia.h2}`}>DOCENTE</h2></div>
          <div className={`${stylesCrearNoticia.atributo} ${stylesCrearNoticia.lugar}`}> <h2 className={`${stylesCrearNoticia.h2}`}>LUGAR</h2></div>
          <div className={`${stylesCrearNoticia.atributo} ${stylesCrearNoticia.horario}`}> <h2 className={`${stylesCrearNoticia.h2}`}>HOARIO</h2></div>
          <div className={`${stylesCrearNoticia.atributo} ${stylesCrearNoticia.localidad}`}> <h2 className={`${stylesCrearNoticia.h2}`}>LOCALIDAD</h2></div>
          <div className={`${stylesCrearNoticia.atributo} ${stylesCrearNoticia.agregar}`}>
            <div className={`${stylesCrearNoticia.btn_add}`}>
              <div className={`${stylesCrearNoticia.add}`}>
        ...
        <div className={`${stylesCrearNoticia.actividades}`}>
          <div className={`${stylesCrearNoticia.actividad}`}> <h2 className={`${stylesCrearNoticia.h2}`}>1/6/23</h2></div>
          <div className={`${stylesCrearNoticia.actividad}`}> <h2 className={`${stylesCrearNoticia.h2}`}>Futbol</h2></div>
          <div className={`${stylesCrearNoticia.actividad}`}> <h2 className={`${stylesCrearNoticia.h2}`}>Diego Lugano</h2></div>
          <div className={`${stylesCrearNoticia.actividad}`}> <h2 className={`${stylesCrearNoticia.h2}`}>Plaza Deporte</h2></div>
          <div className={`${stylesCrearNoticia.actividad}`}> <h2 className={`${stylesCrearNoticia.h2}`}>14hs a 16hs</h2></div>
          <div className={`${stylesCrearNoticia.actividad}`}> <h2 className={`${stylesCrearNoticia.h2}`}>Mercedes</h2></div>
        ...
        <div className={`${stylesCrearNoticia.actividades}`}>
          <div className={`${stylesCrearNoticia.actividad}`}> <h2 className={`${stylesCrearNoticia.h2}`}>30/5/23</h2></div>
          <div className={`${stylesCrearNoticia.actividad}`}> <h2 className={`${stylesCrearNoticia.h2}`}>Natación</h2></div>
          <div className={`${stylesCrearNoticia.actividad}`}> <h2 className={`${stylesCrearNoticia.h2}`}>Michel Phelps</h2></div>
          <div className={`${stylesCrearNoticia.actividad}`}> <h2 className={`${stylesCrearNoticia.h2}`}>Piscina Municipal</h2></div>
          <div className={`${stylesCrearNoticia.actividad}`}> <h2 className={`${stylesCrearNoticia.h2}`}>6hs a 10hs</h2></div>
          <div className={`${stylesCrearNoticia.actividad}`}> <h2 className={`${stylesCrearNoticia.h2}`}>Risso</h2></div>
          <div className={`${stylesCrearNoticia.actividad}`}>
            <div className={`${stylesCrearNoticia.btns}`}>
              <div className={`${stylesCrearNoticia.btn_edit}`}>
                <svg className={`${stylesCrearNoticia.edit}`} xmlns: xlink="http://www.w3.org/1999/xlink" fill="none" width="40" xmlns="http://www.w3.org/2000/svg" id="screenshot-ef9f8d7b-7ae6-8023-8002-ef8780c8ae42" version="1.1" viewBox="2341.048 584.263 17.9 18.739" height="40">
...
<div className={`${stylesCrearNoticia.cont_tabla}`}>
      ...
      <div className={`${stylesCrearNoticia.tabla_mobile}`}>
        ...
        <div className={`${stylesCrearNoticia.fila1}`}>
          <div className={`${stylesCrearNoticia.actividad_mobile} ${stylesCrearNoticia.act_deporte}`}>
            <p className={`${stylesCrearNoticia.p}`}>Futbol</p>
          </div>
          <div className={`${stylesCrearNoticia.actividad_mobile} ${stylesCrearNoticia.act_localidad}`}>
            <p className={`${stylesCrearNoticia.p}`}>Risso</p>
          </div>
        </div>

        <div className={`${stylesCrearNoticia.fila2}`}>
          <div className={`${stylesCrearNoticia.actividad}`}><p className={`${stylesCrearNoticia.izquierda} ${stylesCrearNoticia.p}`}>Docente:</p> <p className={`${stylesCrearNoticia.derecha} ${stylesCrearNoticia.p}`}>Diego Lugano</p></div>
          <div className={`${stylesCrearNoticia.actividad}`}><p className={`${stylesCrearNoticia.izquierda} ${stylesCrearNoticia.p}`}>Lugar:</p> <p className={`${stylesCrearNoticia.derecha} ${stylesCrearNoticia.p}`}>Plaza deportes</p></div>
          <div className={`${stylesCrearNoticia.actividad}`}><p className={`${stylesCrearNoticia.izquierda} ${stylesCrearNoticia.p}`}>Fecha:</p> <p className={`${stylesCrearNoticia.derecha} ${stylesCrearNoticia.p}`}>1/6/23</p></div>
          <div className={`${stylesCrearNoticia.actividad}`}><p className={`${stylesCrearNoticia.izquierda} ${stylesCrearNoticia.p}`}>Horario:</p> <p className={`${stylesCrearNoticia.derecha} ${stylesCrearNoticia.p}`}>14hs a 16hs</p></div>
        ...
        <div className={`${stylesCrearNoticia.fila3}`}>
          ...
          <div className={`${stylesCrearNoticia.btn_edit_m} ${stylesCrearNoticia.espacio}`}>
            <svg className={`${stylesCrearNoticia.edit_m}`} xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="40" xmlns="http://www.w3.org/2000/svg"  id="screenshot-ef9f8d7b-7ae6-8023-8002-ef8780c8ae42" version="1.1" viewBox="2341.048 584.263 17.9 18.739" height="40">
              <g id="shape-ef9f8d7b-7ae6-8023-8002-ef8780c8ae42"  rx="0" ry="0">
                <g id="shape-ef9f8d7b-7ae6-8023-8002-ef8780c90535"  rx="0" ry="0">
                  <g id="shape-ef9f8d7b-7ae6-8023-8002-ef8780c9d58f">
          ...
          <div className={`${stylesCrearNoticia.espacio}`}></div>
          <div className={`${stylesCrearNoticia.espacio}`}></div>
          <div className={`${stylesCrearNoticia.brn_del_m} ${stylesCrearNoticia.espacio}`}>
            <svg className={`${stylesCrearNoticia.del_m} ${stylesCrearNoticia.svg}`} xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="17.901" xmlns="http://www.w3.org/2000/svg"  id="screenshot-ef9f8d7b-7ae6-8023-8002-ef87828ab5a3" version="1.1" viewBox="2381.054 585.184 17.901 16.865" height="16.865">
              <g id="shape-ef9f8d7b-7ae6-8023-8002-ef87828ab5a3">
          ...
          <div className={`${stylesCrearNoticia.btn_arriba} ${stylesCrearNoticia.espacio}`}>
            <svg className={`${stylesCrearNoticia.arriba} ${stylesCrearNoticia.svg}`} xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="19.866" xmlns="http://www.w3.org/2000/svg" id="screenshot-fc514b5e-bea0-802b-8002-f23abc56fadc" version="1.1" viewBox="3085.067 1080.068 19.866 19.866" height="19.866">
  ...
  <div className={`${stylesCrearNoticia.cont_tabla}`}>
    ...
    <div className={`${stylesCrearNoticia.tabla_mobile_cerrada}`}>
      <div className={`${stylesCrearNoticia.fila1_cerrada}`}>
        <div className={`${stylesCrearNoticia.actividad_mobile} ${stylesCrearNoticia.act_deporte}`}>
          <p className={`${stylesCrearNoticia.p}`}>Natación</p>
        </div>
        <div className={`${stylesCrearNoticia.actividad_mobile} ${stylesCrearNoticia.act_localidad}`}>
          <p className={`${stylesCrearNoticia.p}`}>Mercedes</p>
        </div>
      </div>

      <div className={`${stylesCrearNoticia.fila2_cerrada}`}>
      </div>

      <div className={`${stylesCrearNoticia.fila3_cerrada}`}>
        <div className={`${stylesCrearNoticia.espacio}`}></div>
        <p className={`${stylesCrearNoticia.p}`}>6hs A 10hs</p>
        <div className={`${stylesCrearNoticia.btn_abajo}`}>
          <svg className={`${stylesCrearNoticia.abajo}`} xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="19.866" xmlns="http://www.w3.org/2000/svg"  id="screenshot-fc514b5e-bea0-802b-8002-f23cb262ec63" version="1.1" viewBox="3085.067 1251.067 19.866 19.866" height="19.866">
...
<div className={`${stylesCrearNoticia.agrega}`}>

<form className={`${stylesCrearNoticia.form}`} action="">
  <h1 className={`${stylesCrearNoticia.h1}`}>Añadir deporte</h1>

  <label className={`${stylesCrearNoticia.label}`} for="">Fecha</label>
  <input className={`${stylesCrearNoticia.input}`} type="text" placeholder="XX/XX/XXXX" />

  <label className={`${stylesCrearNoticia.label}`} for="">Nombre</label>
  <input className={`${stylesCrearNoticia.input}`} type="text" placeholder="Nombre" />

  <label className={`${stylesCrearNoticia.label}`} for="">Lugar</label>
  <input className={`${stylesCrearNoticia.input}`} type="text" placeholder="Lugar" />

  <label className={`${stylesCrearNoticia.label}`} for="">Horario</label>
  <input className={`${stylesCrearNoticia.input}`} type="text" placeholder="Horario" />


  <label className={`${stylesCrearNoticia.label}`} for="">Localidad</label>
  <input className={`${stylesCrearNoticia.input}`} type="text" placeholder="Localidad" />

  <div className={`${stylesCrearNoticia.div_btns}`}>
    <button className={`${stylesCrearNoticia.btn_cancelar} ${stylesCrearNoticia.button}`}>
      Cancelar <svg className={`${stylesCrearNoticia.svg}`} xmlns: xlink="http://www.w3.org/1999/xlink" fill="none" width="30" xmlns="http://www.w3.org/2000/svg" id="screenshot-c5eece6e-48df-8016-8002-ef9151833b03" version="1.1" viewBox="1401.652 2681 30 30" height="30">
    ...
    <button className={`${stylesCrearNoticia.btn_agregar} ${stylesCrearNoticia.button}`}>
      Agregar <svg className={`${stylesCrearNoticia.svg}`} xmlns: xlink="http://www.w3.org/1999/xlink" fill="none" width="29.023" xmlns="http://www.w3.org/2000/svg" id="screenshot-c5eece6e-48df-8016-8002-ef8dfd3e07c1" version="1.1" viewBox="1726.792 2678 29.023 30" height="30">
