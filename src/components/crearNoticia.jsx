        ...
        <div className={`${stylesCrearNoticia.atributos}`}>
          ...
          <div className={`${stylesCrearNoticia.atributo} ${stylesCrearNoticia.agregar}`}>
            <div className={`${stylesCrearNoticia.btn_add}`}>
              <div onClick={abrirEvento} className={`${stylesCrearNoticia.add}`}>
...
<div id="agregar" className={`${stylesCrearNoticia.agrega}` }>
        <form id="form" onSubmit={handleFormSubmit} className={`${stylesCrearNoticia.form}`}>
          ...
          <div onClick={cerrarEvento} className={`${stylesCrearNoticia.cerrar}`}>
            <img className={`${stylesCrearNoticia.img_cerrar}`} src="/cross2.png" alt="" />
          </div>

          <label className={`${stylesCrearNoticia.label}`} htmlFor="">Titulo del evento</label>
          ...
          <label className={`${stylesCrearNoticia.label}`} htmlFor="">Fecha del evento</label>
          ...
          <div className={`${stylesCrearNoticia.div_btns}`}>
            <button onClick={cerrarEvento} className={`${stylesCrearNoticia.btn_cancelar} ${stylesCrearNoticia.button}`}>
            ...
            <button onClick={cerrarEvento} className={`${stylesCrearNoticia.btn_agregar} ${stylesCrearNoticia.button}`} type="submit">
