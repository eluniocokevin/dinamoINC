...
<div className={`${stylesCrearNoticia.tabla_mobile}`}>
  ...
  <div className={`${stylesCrearNoticia.fila1}`}>
    <div className={`${stylesCrearNoticia.actividad_mobile}`}>
  ...
  <div className={`${stylesCrearNoticia.fila3}`}>
    ...
    <div className={`${stylesCrearNoticia.espacio}`}></div>
    <div className={`${stylesCrearNoticia.espacio}`}></div>
    <div className={`${stylesCrearNoticia.btn_del_m} ${stylesCrearNoticia.espacio}`}>
      <svg className={`${stylesCrearNoticia.del_m} ${stylesCrearNoticia.svg}`} xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="40" xmlns="http://www.w3.org/2000/svg"  id="screenshot-ef9f8d7b-7ae6-8023-8002-ef87828ab5a3" version="1.1" viewBox="2381.054 585.184 17.901 16.865" height="16.865">
        <g id="shape-ef9f8d7b-7ae6-8023-8002-ef87828ab5a3">
    ...
    <div className={`${stylesCrearNoticia.btn_arriba_abajo} ${stylesCrearNoticia.espacio}`}>
      ...
      <svg className={`${stylesCrearNoticia.abajo} ${stylesCrearNoticia.svg} ${arriba ? `${stylesCrearNoticia.arriba}` : ''}`} onClick={toggleActivo} id="botonAbajo" xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="19.866" xmlns="http://www.w3.org/2000/svg"   version="1.1" viewBox="3085.067 1251.067 19.866 19.866" height="19.866">
