  ...
  setFileSelected(!!event.target.files.length);
    ...
    <div className={`${stylesCrearEvento.tabla}`}>
        ...
        <div className={`${stylesCrearEvento.atributos}`}>
          <div className={`${stylesCrearEvento.atributo} ${stylesCrearEvento.fecha}`}> <h2 className={`${stylesCrearEvento.h2}`}>TITULO</h2></div>
          <div className={`${stylesCrearEvento.atributo} ${stylesCrearEvento.nombre}`}> <h2 className={`${stylesCrearEvento.h2}`}>DEPORTE</h2></div>
          <div className={`${stylesCrearEvento.atributo} ${stylesCrearEvento.docente}`}> <h2 className={`${stylesCrearEvento.h2}`}>DESCRIPCION</h2></div>
          <div className={`${stylesCrearEvento.atributo} ${stylesCrearEvento.lugar}`}> <h2 className={`${stylesCrearEvento.h2}`}>LOCALIDAD</h2></div>
          <div className={`${stylesCrearEvento.atributo} ${stylesCrearEvento.localidad}`}> <h2 className={`${stylesCrearEvento.h2}`}>FECHA</h2></div>
          <div className={`${stylesCrearEvento.atributo} ${stylesCrearEvento.horario}`}> <h2 className={`${stylesCrearEvento.h2}`}>IMAGEN</h2></div>
          <div className={`${stylesCrearEvento.atributo} ${stylesCrearEvento.agregar}`}>
            <div className={`${stylesCrearEvento.btn_add}`}>
              <div onClick={abrirEvento} className={`${stylesCrearEvento.add}`}>
                <svg   className={`${stylesCrearEvento.svg_add}`} xmlnsXlink="http://www.w3.org/1999/xlink" fill="none" xmlns="http://www.w3.org/2000/svg" id="screenshot-ef9f8d7b-7ae6-8023-8002-ef87cc3c39b0" version="1.1" viewBox="2352 447.621 30 31.558">
      ...
      <div className={`${stylesCrearEvento.tabla_mobile}`}>
        ...
        <div className={`${stylesCrearEvento.fila3}`}>
          ...
          <div className={`${stylesCrearEvento.brn_del_m} ${stylesCrearEvento.espacio}`}>
            <svg className={`${stylesCrearEvento.del_m} ${stylesCrearEvento.svg}`} xmlnsXlink="http://www.w3.org/1999/xlink" fill="none" width="17.901" xmlns="http://www.w3.org/2000/svg"  id="screenshot-ef9f8d7b-7ae6-8023-8002-ef87828ab5a3" version="1.1" viewBox="2381.054 585.184 17.901 16.865" height="16.865">
          ...
          <div className={`${stylesCrearEvento.btn_arriba} ${stylesCrearEvento.espacio}`}>
            <svg className={`${stylesCrearEvento.arriba} ${stylesCrearEvento.svg}`} xmlnsXlink="http://www.w3.org/1999/xlink" fill="none" width="19.866" xmlns="http://www.w3.org/2000/svg" id="screenshot-fc514b5e-bea0-802b-8002-f23abc56fadc" version="1.1" viewBox="3085.067 1080.068 19.866 19.866" height="19.866">
              <g id="shape-fc514b5e-bea0-802b-8002-f23abc56fadc" rx="0" ry="0">
                <g id="shape-fc514b5e-bea0-802b-8002-f23abc573a95" rx="0" ry="0">
                  <g id="shape-fc514b5e-bea0-802b-8002-f23abc57c894">
                    <g className="fills" id="fills-fc514b5e-bea0-802b-8002-f23abc57c894">
                  ...
                  <g id="shape-fc514b5e-bea0-802b-8002-f23abc580381">
                    <g className="fills" id="fills-fc514b5e-bea0-802b-8002-f23abc580381">
    ...
    <div className={`${stylesCrearEvento.tabla_mobile_cerrada}`}>
      ...
      <div className={`${stylesCrearEvento.fila3_cerrada}`}>
        ...
        <div className={`${stylesCrearEvento.btn_abajo}`}>
          <svg className={`${stylesCrearEvento.abajo}`} xmlnsXlink="http://www.w3.org/1999/xlink" fill="none" width="19.866" xmlns="http://www.w3.org/2000/svg"  id="screenshot-fc514b5e-bea0-802b-8002-f23cb262ec63" version="1.1" viewBox="3085.067 1251.067 19.866 19.866" height="19.866">
            <g id="shape-fc514b5e-bea0-802b-8002-f23cb262ec63"  rx="0" ry="0">
              <g id="shape-fc514b5e-bea0-802b-8002-f23cb262ec64"  rx="0" ry="0">
                <g id="shape-fc514b5e-bea0-802b-8002-f23cb2635a8e">
                  <g className="fills" id="fills-fc514b5e-bea0-802b-8002-f23cb2635a8e">
