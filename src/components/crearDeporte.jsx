          ...
          <div className={`${stylesCrearDeporte.tabla_mobile}`}>
            ...
            <div className={`${stylesCrearDeporte.fila3}`}>
              ...
              <div className={`${stylesCrearDeporte.btn_arriba_abajo} ${stylesCrearDeporte.espacio}`}>
                ...
                <svg className={`${stylesCrearDeporte.abajo} ${stylesCrearDeporte.svg} ${arriba ? `${stylesCrearDeporte.arriba}` : ''}`} onClick={toggleActivo} id="botonAbajo" xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="19.866" xmlns="http://www.w3.org/2000/svg"   version="1.1" viewBox="3085.067 1251.067 19.866 19.866" height="19.866">
