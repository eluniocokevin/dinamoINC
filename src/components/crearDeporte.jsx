import styles from "../css/crearDeporte.module.css";
...
function CrearDeporte(){
    ...
    <div className={`${styles.tabla}`}>
        ...
        <div className={`${styles.atributos}`}>
            <div className={`${styles.atributo} ${styles.fecha}`}> <h2>FECHA</h2></div>
            <div className={`${styles.atributo} ${styles.nombre}`}> <h2>NOMBRE</h2></div>
            <div className={`${styles.atributo} ${styles.docente}`}> <h2>DOCENTE</h2></div>
            <div className={`${styles.atributo} ${styles.lugar}`}> <h2>LUGAR</h2></div>
            <div className={`${styles.atributo} ${styles.horario}`}> <h2>HOARIO</h2></div>
            <div className={`${styles.atributo} ${styles.localidad}`}> <h2>LOCALIDAD</h2></div>
            <div className={`${styles.atributo} ${styles.agregar}`}>
                <div className={`${styles.btn_add}`}>
              <div className={`${styles.add}`}>
                <svg className={`${styles.svg_add}`} xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" xmlns="http://www.w3.org/2000/svg"  id="screenshot-ef9f8d7b-7ae6-8023-8002-ef87cc3c39b0" version="1.1" viewBox="2352 447.621 30 31.558">
                  <g id="shape-ef9f8d7b-7ae6-8023-8002-ef87cc3c39b0"  rx="0" ry="0">
                    <g id="shape-ef9f8d7b-7ae6-8023-8002-ef87cc3c9636">
                      <g className={`${styles.fills}`} id="fills-ef9f8d7b-7ae6-8023-8002-ef87cc3c9636">
                    ...
                    <g id="shape-ef9f8d7b-7ae6-8023-8002-ef87cc3cdd5f">
                      <g className={`${styles.fills}`} id="fills-ef9f8d7b-7ae6-8023-8002-ef87cc3cdd5f">
        ...
        <div className={`${styles.actividades}`}>
            <div className={`${styles.actividad}`}> <h2>1/6/23</h2></div>
            <div className={`${styles.actividad}`}> <h2>Futbol</h2></div>
            <div className={`${styles.actividad}`}> <h2>Diego Lugano</h2></div>
            <div className={`${styles.actividad}`}> <h2>Plaza Deporte</h2></div>
            <div className={`${styles.actividad}`}> <h2>14hs a 16hs</h2></div>
            <div className={`${styles.actividad}`}> <h2>Mercedes</h2></div>
            <div className={`${styles.actividad}`}>
                <div className={`${styles.btns}`}> 
                    <div className={`${styles.btn_edit}`}>
                        <svg className={`${styles.edit}`} xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="40" xmlns="http://www.w3.org/2000/svg"  id="screenshot-ef9f8d7b-7ae6-8023-8002-ef8780c8ae42" version="1.1" viewBox="2341.048 584.263 17.9 18.739" height="40">
                        ...
                        <g id="shape-ef9f8d7b-7ae6-8023-8002-ef8780c90535"  rx="0" ry="0">
                            ...
                            <g className={`${styles.fills}`} id="fills-ef9f8d7b-7ae6-8023-8002-ef8780c9d58f">
                            ...
                            <g className={`${styles.fills}`} id="fills-ef9f8d7b-7ae6-8023-8002-ef8780cadb2e">
            ...
            <div className={`${styles.btn_del}`}>
                <svg className={`${styles.del}`} xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="17.901" xmlns="http://www.w3.org/2000/svg"  id="screenshot-ef9f8d7b-7ae6-8023-8002-ef87828ab5a3" version="1.1" viewBox="2381.054 585.184 17.901 16.865" height="16.865">
                  <g id="shape-ef9f8d7b-7ae6-8023-8002-ef87828ab5a3">
                    <g className={`${styles.fills}`} id="fills-ef9f8d7b-7ae6-8023-8002-ef87828ab5a3">
            ...
            <div className={`${styles.actividades}`}>
            <div className={`${styles.actividad}`}> <h2>30/5/23</h2></div>
            <div className={`${styles.actividad}`}> <h2>Natación</h2></div>
            <div className={`${styles.actividad}`}> <h2>Michel Phelps</h2></div>
            <div className={`${styles.actividad}`}> <h2>Piscina Municipal</h2></div>
            <div className={`${styles.actividad}`}> <h2>6hs a 10hs</h2></div>
            <div className={`${styles.actividad}`}> <h2>Risso</h2></div>
            <div className={`${styles.actividad}`}>
            <div className={`${styles.btns}`}> 
                <div className={`${styles.btn_edit}`}>
                    <svg className={`${styles.edit}`} xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="40" xmlns="http://www.w3.org/2000/svg"  id="screenshot-ef9f8d7b-7ae6-8023-8002-ef8780c8ae42" version="1.1" viewBox="2341.048 584.263 17.9 18.739" height="40">
