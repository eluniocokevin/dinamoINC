...
{/* Acá aparecen los deportes */}
      ...
      <div className={`${stylesCrearDeporte.tabla}`}>
        ...
        <div className={`${stylesCrearDeporte.atributos}`}>
          <div className={`${stylesCrearDeporte.atributo} ${stylesCrearDeporte.fecha}`}> <h2 className={`${stylesCrearDeporte.h2}`}>FECHA</h2></div>
          <div className={`${stylesCrearDeporte.atributo} ${stylesCrearDeporte.nombre}`}> <h2 className={`${stylesCrearDeporte.h2}`}>NOMBRE</h2></div>
          <div className={`${stylesCrearDeporte.atributo} ${stylesCrearDeporte.docente}`}> <h2 className={`${stylesCrearDeporte.h2}`}>DOCENTE</h2></div>
          <div className={`${stylesCrearDeporte.atributo} ${stylesCrearDeporte.lugar}`}> <h2 className={`${stylesCrearDeporte.h2}`}>LUGAR</h2></div>
          <div className={`${stylesCrearDeporte.atributo} ${stylesCrearDeporte.horario}`}> <h2 className={`${stylesCrearDeporte.h2}`}>HOARIO</h2></div>
          <div className={`${stylesCrearDeporte.atributo} ${stylesCrearDeporte.localidad}`}> <h2 className={`${stylesCrearDeporte.h2}`}>LOCALIDAD</h2></div>
        ...
        <div className={`${stylesCrearDeporte.actividades}`}>
          <div className={`${stylesCrearDeporte.actividad}`}> <h2 className={`${stylesCrearDeporte.h2}`}>1/6/23</h2></div>
          <div className={`${stylesCrearDeporte.actividad}`}> <h2 className={`${stylesCrearDeporte.h2}`}>Futbol</h2></div>
          <div className={`${stylesCrearDeporte.actividad}`}> <h2 className={`${stylesCrearDeporte.h2}`}>Diego Lugano</h2></div>
          <div className={`${stylesCrearDeporte.actividad}`}> <h2 className={`${stylesCrearDeporte.h2}`}>Plaza Deporte</h2></div>
          <div className={`${stylesCrearDeporte.actividad}`}> <h2 className={`${stylesCrearDeporte.h2}`}>14hs a 16hs</h2></div>
          <div className={`${stylesCrearDeporte.actividad}`}> <h2 className={`${stylesCrearDeporte.h2}`}>Mercedes</h2></div>
        ...
        <div className={`${stylesCrearDeporte.actividades}`}>
          <div className={`${stylesCrearDeporte.actividad}`}> <h2 className={`${stylesCrearDeporte.h2}`}>30/5/23</h2></div>
          <div className={`${stylesCrearDeporte.actividad}`}> <h2 className={`${stylesCrearDeporte.h2}`}>Natación</h2></div>
          <div className={`${stylesCrearDeporte.actividad}`}> <h2 className={`${stylesCrearDeporte.h2}`}>Michel Phelps</h2></div>
          <div className={`${stylesCrearDeporte.actividad}`}> <h2 className={`${stylesCrearDeporte.h2}`}>Piscina Municipal</h2></div>
          <div className={`${stylesCrearDeporte.actividad}`}> <h2 className={`${stylesCrearDeporte.h2}`}>6hs a 10hs</h2></div>
          <div className={`${stylesCrearDeporte.actividad}`}> <h2 className={`${stylesCrearDeporte.h2}`}>Risso</h2></div>
          <div className={`${stylesCrearDeporte.actividad}`}>
            <div className={`${stylesCrearDeporte.btns}`}>
              <div className={`${stylesCrearDeporte.btn_edit}`}>
                <svg className={`${stylesCrearDeporte.edit}`} xmlns: xlink="http://www.w3.org/1999/xlink" fill="none" width="40" xmlns="http://www.w3.org/2000/svg" id="screenshot-ef9f8d7b-7ae6-8023-8002-ef8780c8ae42" version="1.1" viewBox="2341.048 584.263 17.9 18.739" height="40">
...
<div className={`${stylesCrearDeporte.cont_tabla}`}>
      ...
      <div className={`${stylesCrearDeporte.tabla_mobile}`}>
        ...
        <div className={`${stylesCrearDeporte.fila1}`}>
          <div className={`${stylesCrearDeporte.actividad_mobile} ${stylesCrearDeporte.act_deporte}`}>
            <p className={`${stylesCrearDeporte.p}`}>Futbol</p>
          </div>
          <div className={`${stylesCrearDeporte.actividad_mobile} ${stylesCrearDeporte.act_localidad}`}>
            <p className={`${stylesCrearDeporte.p}`}>Risso</p>
          </div>
        </div>
        ...
        <div className={`${stylesCrearDeporte.fila2} ${stylesCrearDeporte.activo}`}>
          ...
          <div className={`${stylesCrearDeporte.actividad}`}><p className={`${stylesCrearDeporte.izquierda} ${stylesCrearDeporte.p}`}>Horario:</p> <p className={`${stylesCrearDeporte.derecha} ${stylesCrearDeporte.p}`}>14hs a 16hs</p></div>
        ...
        <div className={`${stylesCrearDeporte.fila3}`}>
          ...
          <div className={`${stylesCrearDeporte.btn_edit_m} ${stylesCrearDeporte.espacio}`}>
            <svg className={`${stylesCrearDeporte.edit_m}`} xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="40" xmlns="http://www.w3.org/2000/svg"  id="screenshot-ef9f8d7b-7ae6-8023-8002-ef8780c8ae42" version="1.1" viewBox="2341.048 584.263 17.9 18.739" height="40">
              <g id="shape-ef9f8d7b-7ae6-8023-8002-ef8780c8ae42"  rx="0" ry="0">
                <g id="shape-ef9f8d7b-7ae6-8023-8002-ef8780c90535"  rx="0" ry="0">
                  <g id="shape-ef9f8d7b-7ae6-8023-8002-ef8780c9d58f">
          ...
          <div className={`${stylesCrearDeporte.btn_arriba} ${stylesCrearDeporte.espacio}`}>
            <svg className={`${stylesCrearDeporte.arriba} ${stylesCrearDeporte.svg}`} xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="19.866" xmlns="http://www.w3.org/2000/svg" id="screenshot-fc514b5e-bea0-802b-8002-f23abc56fadc" version="1.1" viewBox="3085.067 1080.068 19.866 19.866" height="19.866">
  ...
  <div className={`${stylesCrearDeporte.cont_tabla}`}>
    ...
    <div className={`${stylesCrearDeporte.tabla_mobile_cerrada}`}>
      <div className={`${stylesCrearDeporte.fila1_cerrada}`}>
        <div className={`${stylesCrearDeporte.actividad_mobile} ${stylesCrearDeporte.act_deporte}`}>
          <p className={`${stylesCrearDeporte.p}`}>Natación</p>
        </div>
        <div className={`${stylesCrearDeporte.actividad_mobile} ${stylesCrearDeporte.act_localidad}`}>
          <p className={`${stylesCrearDeporte.p}`}>Mercedes</p>
        </div>
      </div>

      <div className={`${stylesCrearDeporte.fila2_cerrada}`}>
      </div>

      <div className={`${stylesCrearDeporte.fila3_cerrada}`}>
        <div className={`${stylesCrearDeporte.espacio}`}></div>
...
<div className={`${stylesCrearDeporte.agrega}`}>

<form className={`${stylesCrearDeporte.form}`} action="">
  <h1 className={`${stylesCrearDeporte.h1}`}>Añadir deporte</h1>

  <label className={`${stylesCrearDeporte.label}`} for="">Fecha</label>
  <input className={`${stylesCrearDeporte.input}`} type="text" placeholder="XX/XX/XXXX" />

  <label className={`${stylesCrearDeporte.label}`} for="">Nombre</label>
  <input className={`${stylesCrearDeporte.input}`} type="text" placeholder="Nombre" />

  <label className={`${stylesCrearDeporte.label}`} for="">Lugar</label>
  <input className={`${stylesCrearDeporte.input}`} type="text" placeholder="Lugar" />

  <label className={`${stylesCrearDeporte.label}`} for="">Horario</label>
  <input className={`${stylesCrearDeporte.input}`} type="text" placeholder="Horario" />


  <label className={`${stylesCrearDeporte.label}`} for="">Localidad</label>
  <input className={`${stylesCrearDeporte.input}`} type="text" placeholder="Localidad" />

  <div className={`${stylesCrearDeporte.div_btns}`}>
    <button className={`${stylesCrearDeporte.btn_cancelar} ${stylesCrearDeporte.button}`}>
    ...
    <button className={`${stylesCrearDeporte.btn_agregar} ${stylesCrearDeporte.button}`}>
