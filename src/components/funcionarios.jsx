    ...
    <div className={styles.fila}>
      ...
      <aside>
        ...
        <div className={`${styles.cosas}`}>
          <div className={styles.iz}></div>

          <div className={styles.med}>
            <div className={`${styles.inicio} ${styles.elem}`}><h1></h1></div>
            <div className={`${styles.deportes} ${styles.elem}`}><h1><a onClick={handleDeporte}>Deportes</a></h1></div>
            <div className={`${styles.eventos} ${styles.elem}`}><h1><a onClick={handleEvento}>Eventos</a></h1></div>
            <div className={`${styles.noticias} ${styles.elem} `}><h1><a onClick={handleNoticia}>Noticias</a></h1></div>
            <div className={`${styles.elem}`}><h1></h1></div>
          </div>


          <div className={`${styles.der}`}>
            <div className={`${styles.inicio} ${styles.elem}`}>
            ...
            <div className={`${styles.deportes} ${styles.elem}`}></div>
            <div className={`${styles.elem}`}><svg xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="80" xmlns="http://www.w3.org/2000/svg"  id="screenshot-a23732a4-08d0-80a5-8002-f21d0ac97003" version="1.1" viewBox="841 804 80 80" height="80">
              <g id="shape-a23732a4-08d0-80a5-8002-f21d0ac97003">
                <g className={`${styles.fills}`} id="fills-a23732a4-08d0-80a5-8002-f21d0ac97003">
...
<div class={`${styles.cont_tabla}`}>

    <div class={`${styles.tabla_mobile}`}>

      <div class={`${styles.fila1}`}>
        <div class={`${styles.actividad_mobile} ${styles.act_deporte}`}>
          <p>Futbol</p>
        </div>
        <div class={`${styles.actividad_mobile} ${styles.act_localidad}`}>
          <p>Risso</p>
        </div>
      </div>

      <div class={`${styles.fila2}`}>
        <div class={`${styles.actividad}`}><p class={`${styles.izquierda}`}>Docente:</p> <p class={`${styles.derecha}`}>Diego Lugano</p></div>
        <div class={`${styles.actividad}`}><p class={`${styles.izquierda}`}>Lugar:</p> <p class={`${styles.derecha}`}>Plaza deportes</p></div>
        <div class={`${styles.actividad}`}><p class={`${styles.izquierda}`}>Fecha:</p> <p class={`${styles.derecha}`}>1/6/23</p></div>
        <div class={`${styles.actividad}`}><p class={`${styles.izquierda}`}>Horario:</p> <p class={`${styles.derecha}`}>14hs a 16hs</p></div>

      </div>

      <div class={`${styles.fila3}`}>
        <div class={`${styles.espacio}`}></div>
        <div class={`${styles.espacio}`}></div>
        <div class={`${styles.btn_edit} ${styles.espacio}`}>
          <svg class={`${styles.edit}`} xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="40" xmlns="http://www.w3.org/2000/svg"  id="screenshot-ef9f8d7b-7ae6-8023-8002-ef8780c8ae42" version="1.1" viewBox="2341.048 584.263 17.9 18.739" height="40">
            <g id="shape-ef9f8d7b-7ae6-8023-8002-ef8780c8ae42"  rx="0" ry="0">
              <g id="shape-ef9f8d7b-7ae6-8023-8002-ef8780c90535"  rx="0" ry="0">
                <g id="shape-ef9f8d7b-7ae6-8023-8002-ef8780c9d58f">
                  <g class={`${styles.fills}`} id="fills-ef9f8d7b-7ae6-8023-8002-ef8780c9d58f">
                ...
                <g id="shape-ef9f8d7b-7ae6-8023-8002-ef8780cadb2e">
                  <g class={`${styles.fills}`} id="fills-ef9f8d7b-7ae6-8023-8002-ef8780cadb2e">
        ...
        <div class={`${styles.espacio}`}></div>
        <div class={`${styles.espacio}`}></div>
        <div class={`${styles.btn_del} ${styles.espacio}`}>
          <svg class={`${styles.del}`} xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="17.901" xmlns="http://www.w3.org/2000/svg"  id="screenshot-ef9f8d7b-7ae6-8023-8002-ef87828ab5a3" version="1.1" viewBox="2381.054 585.184 17.901 16.865" height="16.865">
            <g id="shape-ef9f8d7b-7ae6-8023-8002-ef87828ab5a3">
              <g class={`${styles.fills}`} id="fills-ef9f8d7b-7ae6-8023-8002-ef87828ab5a3">
        ...
        <div class={`${styles.btn_arriba} ${styles.espacio}`}>
          <svg class={`${styles.arriba}`} xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="19.866" xmlns="http://www.w3.org/2000/svg"  id="screenshot-fc514b5e-bea0-802b-8002-f23abc56fadc" version="1.1" viewBox="3085.067 1080.068 19.866 19.866" height="19.866">
            <g id="shape-fc514b5e-bea0-802b-8002-f23abc56fadc"  rx="0" ry="0">
              <g id="shape-fc514b5e-bea0-802b-8002-f23abc573a95"  rx="0" ry="0">
                <g id="shape-fc514b5e-bea0-802b-8002-f23abc57c894">
                  <g class={`${styles.fills}`} id="fills-fc514b5e-bea0-802b-8002-f23abc57c894">
                ...
                <g id="shape-fc514b5e-bea0-802b-8002-f23abc580381">
                  <g class={`${styles.fills}`} id="fills-fc514b5e-bea0-802b-8002-f23abc580381">
