...
<div className={`${stylesPreguntas.centrado}`}>
	<div className={`${stylesPreguntas.todo}`}>
		<div className={`${stylesPreguntas.titulos}`}> 
			<div className={`${stylesPreguntas.imagen}`}>
				<img className={`${stylesPreguntas.preguntado}`} src="/pregunta.png" alt="preguntas icon" /> 
			</div>
			<h1 className={`${stylesPreguntas.h1}`}>Preguntas Frecuentes</h1>
			
			<h3 className={`${stylesPreguntas.h3}`}>
			...
			<div className={`${stylesPreguntas.preguntas}`}>
		...
		<div className={`${stylesPreguntas.contacto}`}>

			<h1 className={`${stylesPreguntas.h1}`}>Contacto</h1>
			<Contacto/> 
		</div>
	</div>
</div>
