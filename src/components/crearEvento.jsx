...
function CrearEvento(){
    ...
    <div className={`${styles.tabla}`}>
        <div className={`${styles.h1}`}><h1 >Eventos</h1></div>

        <div className={`${styles.atributos}`}>
            <div className={`${styles.atributo} ${styles.fecha}`}> <h2>DEPORTE</h2></div>
            <div className={`${styles.atributo} ${styles.nombre}`}> <h2>TITULO</h2></div>
            <div className={`${styles.atributo} ${styles.docente}`}> <h2>DESCRIPCIÓN</h2></div>
            <div className={`${styles.atributo} ${styles.lugar}`}> <h2>FECHA</h2></div>
            <div className={`${styles.atributo} ${styles.horario}`}> <h2>IMG</h2></div>
        ...
        <div className={`${styles.actividades}`}>
            <div className={`${styles.actividad}`}> <h2>Remo</h2></div>
            <div className={`${styles.actividad}`}> <h2>Se realizará la 4ta fecha del circuito nacional de remo</h2></div>
            <div className={`${styles.actividad}`}> <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit.</h2></div>
            <div className={`${styles.actividad}`}> <h2>10/10/2023</h2></div>
            <div className={`${styles.actividad}`}> <h2>evento.jpg</h2></div>
            ...
            <div className={`${styles.actividades}`}>
            <div className={`${styles.actividad}`}> <h2>Skate</h2></div>
            <div className={`${styles.actividad}`}> <h2>Se inagura pista de skate</h2></div>
            <div className={`${styles.actividad}`}> <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit.</h2></div>
            <div className={`${styles.actividad}`}> <h2>10/08/2023</h2></div>
            <div className={`${styles.actividad}`}> <h2>evento.jpg</h2></div>
            <div className={`${styles.actividad}`}>
            <div className={`${styles.btns}`}> 
                <div className={`${styles.btn_edit}`}>
