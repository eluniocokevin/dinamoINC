...
function CrearEvento(){
    ...
    <div className={`${stylesCrearEvento.tabla}`}>
        ...
        <div className={`${stylesCrearEvento.atributos}`}>
            <div className={`${stylesCrearEvento.atributo} ${stylesCrearEvento.fecha}`}> <h2>DEPORTE</h2></div>
            <div className={`${stylesCrearEvento.atributo} ${stylesCrearEvento.nombre}`}> <h2>TITULO</h2></div>
            <div className={`${stylesCrearEvento.atributo} ${stylesCrearEvento.docente}`}> <h2>DESCRIPCIÓN</h2></div>
