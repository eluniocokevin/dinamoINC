      ...
      <div className={`${stylesEditarUsuarios.tabla_mobile}`}>
        ...
        <div className={`${stylesEditarUsuarios.fila3}`}>
          ...
          <div className={`${stylesEditarUsuarios.btn_edit_m} ${stylesEditarUsuarios.espacio}`}>
            <svg className={`${stylesEditarUsuarios.edit_m}`} xmlnsXlink="http://www.w3.org/1999/xlink" fill="none" width="40" xmlns="http://www.w3.org/2000/svg"  id="screenshot-ef9f8d7b-7ae6-8023-8002-ef8780c8ae42" version="1.1" viewBox="2341.048 584.263 17.9 18.739" height="40">
              <g id="shape-ef9f8d7b-7ae6-8023-8002-ef8780c8ae42"  rx="0" ry="0">
                <g id="shape-ef9f8d7b-7ae6-8023-8002-ef8780c90535"  rx="0" ry="0">
                  <g id="shape-ef9f8d7b-7ae6-8023-8002-ef8780c9d58f">
          ...
          <div className={`${stylesEditarUsuarios.brn_del_m} ${stylesEditarUsuarios.espacio}`}>
            <svg className={`${stylesEditarUsuarios.del_m} ${stylesEditarUsuarios.svg}`} xmlnsXlink="http://www.w3.org/1999/xlink" fill="none" width="17.901" xmlns="http://www.w3.org/2000/svg"  id="screenshot-ef9f8d7b-7ae6-8023-8002-ef87828ab5a3" version="1.1" viewBox="2381.054 585.184 17.901 16.865" height="16.865">
              <g id="shape-ef9f8d7b-7ae6-8023-8002-ef87828ab5a3">
          ...
          <div className={`${stylesEditarUsuarios.btn_arriba} ${stylesEditarUsuarios.espacio}`}>
            <svg className={`${stylesEditarUsuarios.arriba} ${stylesEditarUsuarios.svg}`} xmlnsXlink="http://www.w3.org/1999/xlink" fill="none" width="19.866" xmlns="http://www.w3.org/2000/svg" id="screenshot-fc514b5e-bea0-802b-8002-f23abc56fadc" version="1.1" viewBox="3085.067 1080.068 19.866 19.866" height="19.866">
    ...
    <div className={`${stylesEditarUsuarios.tabla_mobile_cerrada}`}>
      ...
      <div className={`${stylesEditarUsuarios.fila3_cerrada}`}>
        ...
        <div className={`${stylesEditarUsuarios.btn_abajo}`}>
          <svg className={`${stylesEditarUsuarios.abajo}`} xmlnsXlink="http://www.w3.org/1999/xlink" fill="none" width="19.866" xmlns="http://www.w3.org/2000/svg"  id="screenshot-fc514b5e-bea0-802b-8002-f23cb262ec63" version="1.1" viewBox="3085.067 1251.067 19.866 19.866" height="19.866">
