import stylesCrearEvento from "../css/editarUsuarios.module.css";
...
return(
    ...
    <div className={`${stylesCrearEvento.tabla}`}>
        <div className={`${stylesCrearEvento.h1}`}><h1 >Eventos</h1></div>

        <div className={`${stylesCrearEvento.atributos}`}>
            <div className={`${stylesCrearEvento.atributo} ${stylesCrearEvento.fecha}`}> <h2>NOMBRE</h2></div>
            <div className={`${stylesCrearEvento.atributo} ${stylesCrearEvento.nombre}`}> <h2>CI</h2></div>
            <div className={`${stylesCrearEvento.atributo} ${stylesCrearEvento.docente}`}> <h2>FUA</h2></div>
            <div className={`${stylesCrearEvento.atributo} ${stylesCrearEvento.lugar}`}> <h2>FECHA</h2></div>
            <div className={`${stylesCrearEvento.atributo} ${stylesCrearEvento.horario}`}> <h2>IMG</h2></div>
        ...
        <div className={`${stylesCrearEvento.actividades}`}>
            <div className={`${stylesCrearEvento.actividad}`}> <h2>Remo</h2></div>
            <div className={`${stylesCrearEvento.actividad}`}> <h2>Se realizará la 4ta fecha del circuito nacional de remo</h2></div>
            <div className={`${stylesCrearEvento.actividad}`}> <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit.</h2></div>
            <div className={`${stylesCrearEvento.actividad}`}> <h2>10/10/2023</h2></div>
            <div className={`${stylesCrearEvento.actividad}`}> <h2>evento.jpg</h2></div>
            ...
            <div className={`${stylesCrearEvento.actividades}`}>
            <div className={`${stylesCrearEvento.actividad}`}> <h2>Skate</h2></div>
            <div className={`${stylesCrearEvento.actividad}`}> <h2>Se inagura pista de skate</h2></div>
            <div className={`${stylesCrearEvento.actividad}`}> <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit.</h2></div>
            <div className={`${stylesCrearEvento.actividad}`}> <h2>10/08/2023</h2></div>
            <div className={`${stylesCrearEvento.actividad}`}> <h2>evento.jpg</h2></div>
            <div className={`${stylesCrearEvento.actividad}`}>
            <div className={`${stylesCrearEvento.btns}`}> 
                <div className={`${stylesCrearEvento.btn_edit}`}>
